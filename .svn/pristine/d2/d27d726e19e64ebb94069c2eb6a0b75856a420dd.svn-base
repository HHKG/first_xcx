        ...
        success(data) {
          ...
          if (data.data.code == 1) {
            ...
            if (that.data.pattern == 0) {
              ...
              paytype = [{
                  name: '微信支付',
                  img: 'http://api.iqianclub.com/upload/program/images/wechat_icon.png',
                  value: '4',
                  checked: 'true'
                },
                {
                  name: "消费金(" + data.data.wallet.E_Consumption + ")",
                  img: 'http://api.iqianclub.com/upload/program/images/xiaofeijin_icon.png',
                  value: '1'
                },
                {
                  name: "余额(" + data.data.wallet.E_Balance + ")",
                  img: 'http://api.iqianclub.com/upload/program/images/yuer_icon.png',
                  value: '2',
                },
              ]
            } else {
